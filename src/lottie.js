  ...
  function Lottie() {
    ...
    return (
      (_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3.default)(
        this,
        (_ref =
          Lottie.__proto__ || (0, _getPrototypeOf2.default)(Lottie)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
  ...
  (0, _createClass3.default)(Lottie, [
    {
      ...
      value: function componentDidMount() {
        ...
        var loop = options.loop,
          ...
          goToAndPlay = options.goToAndPlay,
          goToAndStop = options.goToAndStop;
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (
          (0, _stringify2.default)(this.props.goToAndPlay) !==
          (0, _stringify2.default)(prevProps.goToAndPlay)
        ) {
          this.goToAndPlay();
        }

        if (
          (0, _stringify2.default)(this.props.goToAndStop) !==
          (0, _stringify2.default)(prevProps.goToAndStop)
        ) {
          this.goToAndStop();
        }
